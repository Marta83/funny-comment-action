import { Kind, typeFromAST, TypeInfo, visit, visitWithTypeInfo, print, getNamedType, isAbstractType, isObjectType, isInterfaceType, TypeNameMetaFieldDef, getNullableType, isLeafType, isCompositeType, isListType, isSchema, getOperationAST, execute, subscribe, validate, defaultFieldResolver, parse } from 'graphql';
...
const sortSubschemasByProxiability = memoize4(function (mergedTypeInfo, sourceSubschemaOrSourceSubschemas, targetSubschemas, fieldNodes) {
    ...
    const types = sourceSubschemas.map(sourceSubschema => sourceSubschema.schema.getType(typeName));
    targetSubschemas.forEach(t => {
        ...
        else if (fieldNodes.every(fieldNode => {
